...
export const DISTRICTS_BY_STATE = {
  ...
  Telangana: [
    'Hyderabad', 'Nagarjuna Sagar', 'Ananthagiri Hills',
  ],
  Puducherry: [
...
const PLACES = [
  ...
  { id: 'ka-mangalore-tannirbhavi', name: 'Tannirbhavi Beach', district: 'Mangalore', state: 'Karnataka', category: 'beaches', rating: 4.4, lat: 12.8944, lng: 74.8130, budget: 1500, bestSeason: 'Oct - Mar', image: img('1544735716-392fe2489ffa'), description: 'Light serene beach flanked by tall pine trees, popular for quiet nature walks.' },
